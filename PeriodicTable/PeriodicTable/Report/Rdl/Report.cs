namespace PeriodicTable.Report.Rdl
{
    ...
    public class Report
    {
        ...
        private  Body body = null;  // cool add 
        ...
        {
            throw new System.Exception("2008 spec not definite <reportSection> .");
        ...
        {
            XNamespace ns = "http://schemas.microsoft.com/sqlserver/reporting/2008/01/reportdefinition"; // cool modify
